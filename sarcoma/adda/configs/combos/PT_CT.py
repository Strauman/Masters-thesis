from .. import ADDA_CFG_TEMPLATE, util, summary_call, Trainer_CFG, COMBO_CFG
...
def target_optim(*args, **kwargs):
    ...
    # return tf.train.GradientDescentOptimizer(learning_rate=0.0002)
PT_CT_UPDATES = ADDA_CFG_TEMPLATE(
