from .. import ADDA_CFG_TEMPLATE, util, Trainer_CFG, summary_call, COMBO_CFG, CFG_Models
...
def target_optim(*args, **kwargs):
    ...
    # return tf.train.GradientDescentOptimizer(learning_rate=0.0002)
PT_T2_UPDATES = ADDA_CFG_TEMPLATE(
    # models=CFG_Models(
    #     is_template=True,
    #     discriminator=unet.conv_discriminator_PT_T2
    # ),
...
def disc_optim_reset(*args, **kwargs):
    return tf.train.AdamOptimizer(learning_rate=0.001, beta1=0.7, beta2=0.999)
